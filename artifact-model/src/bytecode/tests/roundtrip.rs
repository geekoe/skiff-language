...
/// The table is ascending, complete (64 rows) and lookup-consistent.
#[test]
fn opcode_table_is_complete_sorted_and_lookup_consistent() {
    let expected: Vec<u8> = vec![
        ...
        0x44, 0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0x5A, 0x5B, 0x5C, 0x60,
        0x61, 0x70, 0x71, 0x72, 0x73, 0x80, 0x81, 0x90, 0x91, 0x92, 0x93, 0x94, 0x95, 0x96, 0x97,
        0x98, 0x99, 0x9A, 0x9B,
    ];
    ...
    for forbidden in [
        0x09, 0x0F, 0x16, 0x1F, 0x27, 0x34, 0x45, 0x5D, 0x62, 0x74, 0x82, 0x8F, 0x9C, 0xFF,
    ] {
        assert_eq!(
...
fn opcode_table_fingerprint_with_operand_roles_is_frozen() {
    assert_eq!(
        ...
        "d95ab71492e6481916d6371781abe0a4bfc71d115040848fa1e14c877fc9f8aa"
    );
}
