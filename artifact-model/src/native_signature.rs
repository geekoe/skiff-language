...
pub static STD_NATIVE_CALLABLE_SEMANTICS: LazyLock<Vec<NativeCallableSemantics>> =
    LazyLock::new(|| {
        vec![
            ...
            detached_scalar_native("core.bytes.toUtf8String"),
...
pub const STD_NATIVE_SIGNATURES: &[NativeSignatureDef] = &[
    ...
    NativeSignatureDef {
        ...
        binding_key: "core.bytes.toUtf8String",
        aliases: &[],
        type_param_count: 0,
        params: &[BYTES],
        return_type: STRING,
    ...
    NativeSignatureDef {
        target: "Array.push",
        binding_key: "core.array.push",
        aliases: &[],
        type_param_count: 1,
        params: &[NativeSignatureTypeExpr::Array(&T0), T0],
        return_type: VOID,
    },
    NativeSignatureDef {
