...
/// JSON value reader that rejects duplicate keys before a map can silently
/// overwrite them. This applies recursively, including operation and schema
/// maps inside a ServiceContract.
