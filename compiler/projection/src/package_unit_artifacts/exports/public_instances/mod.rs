...
use crate::{
    error::ProjectionError, publication_visible_types::PublicationVisibleTypeNames,
    typed_artifacts::interface_methods::PackageTypeSymbolIndex,
};

use super::package_scoped_export_symbol;
use crate::package_unit_artifacts::PackageIrProjectionSource;
