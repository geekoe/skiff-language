...
"#,
        ...
        let gateway_target =
            &fixture.project.package.artifact.callable_links[gateway_handler].target;
    ...
    fn selector_body_shape_implementation_and_adapter_plan_obey_identity_boundaries() {
        ...
        let selector_deployment =
            base.generate_with(&selector_service, &base.project.package.artifact);
        assert_eq!(
