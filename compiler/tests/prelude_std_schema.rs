...
"#,
        ...
        let project =
            compile_package_project(temp.path()).expect("explicit std import should compile");
        let std = project
...
"#,
        ...
        let project =
            compile_package_project(temp.path()).expect("builtin boundary should compile");
...
"#,
        ...
        let project = compile_package_project(temp.path())
            .expect("imported HTTP boundary source should compile");
...
"#,
        ...
        let project =
            compile_package_project(temp.path()).expect("callback package should compile");
...
"#,
        ...
        let project = compile_package_project(temp.path())
            .expect("exact any-interface callback should compile");
