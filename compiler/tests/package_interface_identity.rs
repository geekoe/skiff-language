...
const DIRECT_PROVIDER_BUILD_ID: &str =
    "skiff-package-build-v10:sha256:f28e5aa0bbc8f2173c694b7f2be3cd11b16d437ec0e412959e872cf5837e04ad";
...
"#,
    ...
    assert_eq!(
        ...
        package_artifact_ref(&standalone.package.artifact).expect("standalone provider receipt"),
...
"#,
    ...
    let project = compile_package_project(consumer.path())
        .expect("dependency-owned interface signatures should match the direct exact dependency");
    let facade = project
