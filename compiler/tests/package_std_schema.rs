...
"#,
    ...
    let project = compile_package_project(temp.path()).expect("platform std schema should compile");
...
"#,
    ...
    let project = compile_package_project(temp.path()).expect("bare HTTP envelopes should compile");
