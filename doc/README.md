...
- `reference/`：稳定规则，包括 syntax、static semantics、`api.yml`、service/config authoring、interface、runtime、DB、queue、dispatch、observability、file and command、std surface 和 testing。
