...
- `reference/`：稳定规则，包括 syntax、static semantics、`api.yml`、service/config authoring、interface、runtime、DB、queue、dispatch、observability、file and command、record spread、std surface 和 testing。
