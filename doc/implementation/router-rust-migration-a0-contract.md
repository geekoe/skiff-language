...
- 权威设计：`doc/implementation/router-rust-migration-plan.md` §2.4（actor routing
...
- 直接父批次：`doc/implementation/router-rust-migration-batch-3.md`（A0 条款与验证
  owner）。
- 叶子任务：`doc/implementation/router-rust-migration-a0-leaf.md`。
