...
- 冻结契约：`doc/implementation/router-rust-migration-c-model-spawn-contract.md`
  （方向标注自相矛盾，本叶子按权威设计修复）、
...
- 批次：`doc/implementation/router-rust-migration-batch-9.md`
...
1. `doc/implementation/router-rust-migration-c-model-spawn-contract.md`。
...
14. `doc/implementation/router-rust-migration-m-spawn-repair-leaf.md`
    （本文件）。
