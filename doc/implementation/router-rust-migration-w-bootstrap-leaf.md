...
- 冻结契约：
  ...
  - `doc/implementation/router-rust-migration-c-model-artifact-contract.md`
  - `doc/implementation/router-rust-migration-c-model-bootstrap-wire-contract.md`
  - `doc/implementation/router-rust-migration-contracts-bootstrap-leaf.md`
...
- `doc/implementation/router-rust-migration-w-bootstrap-leaf.md`（本文件）。
