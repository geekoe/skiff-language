...
- 直接父批次（batch 2，已合入基线）：`doc/implementation/router-rust-migration-batch-2.md`、
  `doc/implementation/router-rust-migration-m0-decisions.md`（M0 已把 activation family
...
| 文件 | 内容 |
| --- | --- |
| `doc/implementation/router-rust-migration-contracts-activation-leaf.md` | 本文件（叶子任务） |
| `doc/implementation/router-rust-migration-c-router-activation-state.md` | C-router-activation-state 契约冻结 |
| `doc/implementation/router-rust-migration-c-model-activation.md` | C-model-activation 契约冻结 |
| `doc/implementation/router-rust-migration-c-activation-coordinator.md` | C-activation-coordinator 契约冻结 |
