...
- 权威设计：`doc/implementation/router-rust-migration-plan.md` §7 E-http
...
- E-dispatch gate leaf：`doc/implementation/router-rust-e-dispatch-gate-leaf.md`
  （等价 seam = 生产 `DispatcherHttpPort`）。
- W-http leaf：`doc/implementation/router-rust-migration-w-http-leaf.md`
