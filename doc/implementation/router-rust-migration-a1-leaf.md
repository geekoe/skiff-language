...
- 直接父批次：`doc/implementation/router-rust-migration-batch-4.md`（DAG 节点 A1：
  A0 已建 `actor_routing`，A1 加 producer）。
- A0 冻结契约：`doc/implementation/router-rust-migration-a0-contract.md`（§2 schema、
...
1. 本叶子：`doc/implementation/router-rust-migration-a1-leaf.md`。
