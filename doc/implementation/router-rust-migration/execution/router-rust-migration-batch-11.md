...
直接父批次：`doc/implementation/router-rust-migration/execution/router-rust-migration-batch-10.md`（已 push 到
...
- 新增 `doc/architecture/router-rust.md`（长期 owner/contract 汇总：进程拓扑、state owner、
  wire/artifact/durable model 归属、named gates）；`doc/implementation/router-rust-migration/execution/router-rust-migration-plan.md`
