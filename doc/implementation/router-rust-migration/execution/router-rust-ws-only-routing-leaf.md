...
- `doc/implementation/router-rust-migration/execution/router-rust-ws-only-routing-leaf.md`（本文件）；
- `doc/implementation/router-rust-migration/execution/router-rust-e-ws-gate-leaf.md`（仅追加本节点处理
  记录）。
