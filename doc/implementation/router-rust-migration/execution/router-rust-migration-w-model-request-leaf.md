...
- 批次文档：`doc/implementation/router-rust-migration/execution/router-rust-migration-batch-6.md`
...
- 权威设计：`doc/implementation/router-rust-migration/execution/router-rust-migration-plan.md`（draft v5），
  ...
  设计为准。
- 冻结契约：`doc/implementation/router-rust-migration/contracts/router-rust-migration-c-model-request-contract.md`
  （corpus：`runtime/transport/testdata/request-wire/`；§9 为
  W-model-request 交付义务）。
- 同链契约：`doc/implementation/router-rust-migration/contracts/router-rust-migration-c-dispatch-contract.md`
...
- 先例叶子：`doc/implementation/router-rust-migration/execution/router-rust-migration-w-model-leaf.md`
...
7. `doc/implementation/router-rust-migration/execution/router-rust-migration-w-model-request-leaf.md`
   （本文件）。
