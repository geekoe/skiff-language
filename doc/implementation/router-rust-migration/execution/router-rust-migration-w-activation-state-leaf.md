...
- 批次文档：`doc/implementation/router-rust-migration/execution/router-rust-migration-batch-4.md`
...
| 文件 | 内容 |
| --- | --- |
| `doc/implementation/router-rust-migration/execution/router-rust-migration-w-activation-state-leaf.md` | 本文件（叶子任务） |
