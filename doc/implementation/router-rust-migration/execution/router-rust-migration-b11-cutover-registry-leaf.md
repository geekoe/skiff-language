...
- 批次文档：`doc/implementation/router-rust-migration/execution/router-rust-migration-batch-11.md`（节点 2
...
4. `doc/implementation/router-rust-migration/execution/router-rust-migration-plan.md` 状态由 draft v5 改为
...
- 允许：`scripts/lib/verify-rust-subjects.mjs`、
  ...
  `doc/implementation/router-rust-migration/execution/router-rust-migration-plan.md`（仅状态/头部注释）、
  本叶子任务文件。
