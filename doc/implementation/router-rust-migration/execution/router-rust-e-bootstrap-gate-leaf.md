...
- 冻结契约：`doc/implementation/router-rust-migration/contracts/router-rust-migration-c-bootstrap-contract.md`、
...
- `doc/implementation/router-rust-migration/execution/router-rust-e-bootstrap-gate-leaf.md`（本文件）。
