...
- 冻结契约：`doc/implementation/router-rust-migration/contracts/router-rust-migration-c-routing-query-contract.md`
  （本节点直接消费）、`doc/implementation/router-rust-migration/contracts/router-rust-migration-c-session-contract.md`
  （directory/identity/cancellation）、`doc/implementation/router-rust-migration/contracts/router-rust-migration-c-dispatch-contract.md`
  （lease 消费方）。
- 兄弟叶子：`doc/implementation/router-rust-migration/execution/router-rust-migration-contracts-request-leaf.md`
...
- `doc/implementation/router-rust-migration/execution/router-rust-migration-w-routing-query-leaf.md`
  （本文件）。
