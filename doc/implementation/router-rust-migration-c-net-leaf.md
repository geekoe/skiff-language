...
- 直接父节点：`doc/implementation/router-rust-migration-batch-2.md`（M0 + C-net 批次调度）。
- 本叶子执行 contract 决策落盘：`doc/implementation/router-rust-migration-c-net-contract.md`。
...
- `doc/implementation/router-rust-migration-c-net-leaf.md`、
