...
mod tests {
    ...
    use skiff_artifact_model::{
        ...
        DbFieldStorageIr, DbObjectFieldIr, DbObjectKeyIr, DbObjectKindIr, FileIrRef, FileIrUnit,
        FunctionTypeParamIr, InterfaceInstantiationRef, MetadataValue, OperationAbiRef,
        OperationCallableKind, OperationTargetRef, PackageDependencyConstraint,
        ...
        PackageUnit, PublicationOperationAbi, PublicationOperationKind,
        PublicationPublicInstanceExport, PublicationResourceRef, PublicationSchemaType,
        PublicationSchemaTypeNameability, ServiceOperation, SourceCallMethodIndexEntry,
    ...
    fn complex_artifact_identity_outputs_match_exact_golden() {
        ...
        let actual = [
            function_id,
            instance_id,
            publication_abi_identity(&package.publication_abi)
                .expect("publication identity golden"),
