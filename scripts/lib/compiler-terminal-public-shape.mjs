...
export const terminalPublicShapeRegistry = [
  {
    ...
    publicItems: {
      struct: [
        'BytecodeCompilationAuthorityPins',
        'BytecodeCompilationHandoff',
        'BytecodeCompilationReceipt',
        'BytecodeStatementManifestReceipt',
        'CompiledPackage',
      ],
      enum: [
        'BytecodeCompilationHandoffError',
        'BytecodeCompilationOutcome',
        'ProjectionInputBuildError',
      ],
      fn: [
        'build_projection_input',
        'build_public_instance_operation_facts',
        'compile_parsed_publication_sources',
        'compile_source_model',
      ],
      const: [],
      mod: ['bytecode_handoff', 'projection_input', 'service_contract'],
      static: [],
      trait: [],
      type: [],
      union: [],
  ...
  },
  {
    ...
    publicItems: {
      struct: [
        ...
        'ProjectionInput',
        'ProjectionLocalInterfaceConformance',
        'ProjectionLocalInterfaceConformanceFacts',
      ...
      enum: [
        ...
        'ProjectionLocalInterfaceConformanceError',
        'ProjectionLocalInterfaceConformanceFactsError',
...
`,
  ...
  await expectTerminalPublicShapeSelfTestFailure(
    ...
    terminalMutateFixture(canonicalFiles, compiledRoot, (text) =>
      text.replace(', ProjectionInputBuildError};\n', '};\n'),
    ),
