...
export function phase5ScenarioSpecs(root) {
  return Object.freeze([
    ...
    hostExact(root, 'phase-5-s3-emission-to-atomic-link-input', HOST_TEST.s3,
      ['G3', 'V5R', 'P5G']),
    hostExact(root, 'phase-5-s4-atomic-link-to-image', HOST_TEST.s4,
      ['G4', 'V5R', 'P5G']),
    hostExact(root, 'phase-5-s5-image-to-scheduler', HOST_TEST.s5,
      ['G5', 'K5', 'H5', 'P5G']),
    ...
    rustSuite(root, 'c5-production-affine-publication', 'skiff-compiler',
      ...
      ['G1', 'G2', 'G9', 'C5'], 1),
    rustSuite(root, 'v5r-production-affine-image', 'skiff-runtime-linker',
      'production_stream_image_proves_exact_privileged_shape_and_affine_body_take',
      ['G3', 'G4', 'G9', 'V5R'], 1),
    rustSuite(root, 'v5r-indexed-typed-executor-target', 'skiff-runtime-linker',
      'production_sleep_image_exposes_only_the_indexed_typed_executor_target',
      ['G3', 'G9', 'V5R'], 1),
    rustSuite(root, 'v5r-registry-executor-identity-closure', 'skiff-runtime-linker',
      'executor_identity', ['G3', 'G9', 'V5R'], 3),
    rustSuite(root, 'v5r-host-signature-drift-rejections', 'skiff-runtime-linker',
      'wrong_host_', ['G3', 'G9', 'V5R'], 3),
    rustSuite(root, 'v5r-host-binding-key-rejections', 'skiff-runtime-linker',
      'unknown_and_missing_binding_keys_fail_closed', ['G3', 'G9', 'V5R'], 1),
    ...
    rustSuite(root, 'v5r-atomic-image-runtime-views', 'skiff-runtime-linker',
      ...
      ['G4', 'G9', 'V5R'], 1),
    rustSuite(root, 'v5r-swapped-resume-descriptor-rejection', 'skiff-runtime-linker',
      'atomic_image_resume_view_rejects_swapped_descriptor_with_typed_construction_error',
      ['G4', 'G9', 'V5R'], 1),
