...
function taskBuilders({
  ...
  const builders = {
    ...
    'bytecode-vm-phase-1-gate': async () => [
      task(
        root,
        'bytecode-vm-phase-1:gate',
        'implementation:runtime',
        'node',
        ['scripts/run-bytecode-vm-phase-1-gate.mjs'],
      ),
    ],
    'bytecode-vm-phase-2-gate': async () => [
      task(
        root,
        'bytecode-vm-phase-2:gate',
        'implementation:runtime',
        'node',
        ['scripts/run-bytecode-vm-phase-2-gate.mjs'],
      ),
    ],
    'bytecode-vm-phase-3-gate': async () => [
      task(
        root,
        'bytecode-vm-phase-3:gate',
        'implementation:runtime',
        'node',
        ['scripts/run-bytecode-vm-phase-3-gate.mjs'],
      ),
    ],
    'bytecode-vm-phase-4-gate': async () => [
      task(
        root,
        'bytecode-vm-phase-4:gate',
        'implementation:runtime',
        'node',
        ['scripts/run-bytecode-vm-phase-4-gate.mjs'],
      ),
    ],
    'bytecode-vm-phase-5-gate': async () => [
      task(
        root,
        'bytecode-vm-phase-5:gate',
        'implementation:runtime',
        'node',
        ['scripts/run-bytecode-vm-phase-5-gate.mjs'],
        { exclusive: true },
      ),
    ],
    ...
    'bytecode-vm-phase-7-gate': async () => [
      task(
        root,
        'bytecode-vm-phase-7:gate',
        'implementation:runtime',
        'node',
        ['scripts/run-bytecode-vm-phase-7-gate.mjs'],
        { exclusive: true, slots: 1 },
      ),
    ],
