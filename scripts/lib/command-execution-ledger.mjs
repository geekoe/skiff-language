...
export const COMMAND_EXECUTION_LEDGER = deepFreeze([
  ...
  owner('scripts/lib/artifact-identity-validation.mjs', 'spawn', 'spawn',
    'artifact-identity-cli', 'runIdentityCli', 'binary-adapter',
    'artifact identity validation exchanges canonical JSON with the identity CLI'),
