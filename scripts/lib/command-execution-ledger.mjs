...
export const COMMAND_EXECUTION_LEDGER = deepFreeze([
  ...
  owner('scripts/skiff-instance-legacy.mjs', 'spawn', 'spawnManagedChild',
  ...
  owner('scripts/lib/activation-state-live-harness.mjs', 'spawn', 'spawn',
    'activation-state-mongo-spawn', 'spawnMongodProcess', 'managed-component',
