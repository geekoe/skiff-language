...
export const GATE_POLICY = Object.freeze([
  Object.freeze({
    name: 'skiff-compiler-publication-abi',
  ...
  Object.freeze({
    name: 'skiff-compiler-input-model',
    allowedCrates: Object.freeze([
  ...
  Object.freeze({
    name: 'skiff-compiler-projection-input',
    allowedCrates: Object.freeze([
  ...
  Object.freeze({
    name: 'skiff-compiler-projection',
    allowedCrates: Object.freeze([
