...
mod tests {
    ...
    fn request_with_target(target: &str) -> RequestEnvelope {
        RequestEnvelope {
            ...
            service_protocol_identity: "skiff-service-protocol-v2:sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb".to_string(),
    ...
    fn outbound_context_uses_canonical_operation_target_as_caller_target() {
        ...
        let start = context.request_start_control_for_test(
            concrete::OutboundServiceRequestStart {
                ...
                service_protocol_identity: "skiff-service-protocol-v2:sha256:dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd".to_string(),
