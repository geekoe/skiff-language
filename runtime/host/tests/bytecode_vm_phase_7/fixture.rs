...
impl Capability {
    pub fn package_id(self) -> &'static str {
        match self {
            ...
            Self::HttpStream => "test.skiff/bytecode-vm-phase-7-http-stream",
            Self::HttpStreamSlow => "test.skiff/bytecode-vm-phase-7-http-stream-slow",
    ...
    pub fn path(self) -> String {
        let directory = match self {
            ...
            Self::HttpStreamSlow => "http-stream-slow",
    ...
    pub fn ingress_path(self) -> &'static str {
        match self {
            ...
            Self::HttpStream => "/phase-7/http-stream",
            Self::HttpStreamSlow => "/phase-7/http-stream-slow",
