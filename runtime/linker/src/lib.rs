...
pub use program::{
    ...
    GatewayConfig, InterfaceDeclIr, InterfaceOperationIr, LinkedBoxSourceIr, LinkedCallTarget,
    LinkedConcurrentLaneIr, LinkedConcurrentPlanIr, LinkedConstExport, LinkedExecutable,
    LinkedExecutableBody, LinkedExecutableExport, LinkedExprIr, LinkedFileUnit,
    ...
    SlotBindingIr, SlotIr, SlotLayoutIr, SourceAstHash, SourceMapDto, StmtRefIr, TaskTargetIr,
    TaskTargetKindIr, TypeAddr, TypeDeclIr, TypeExport, TypeIndex, UnaryOpIr, UnitAddr,
};
pub use resolver::{
