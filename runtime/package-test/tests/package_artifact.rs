...
mod tests {
    ...
    fn entrypoint_validation_rejects_non_exact_gateway_facts() {
        ...
        wrong_identity.gateway_entry_identity = GatewayEntryIdentity::parse(format!(
    ...
    fn ambiguous_provider_and_service_call_without_deployment_are_rejected_by_assembly_resolution()
    {
        ...
        duplicate.deployment_revision =
            skiff_artifact_model::DeploymentRevision::new("provider-r2");
