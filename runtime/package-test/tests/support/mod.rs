...
use skiff_artifact_model::{
    ...
    CallableSemanticFacts, ContractDiagnosticText, ContractOperationId, ContractRequirement,
    DeploymentArtifactIdentity, DeploymentDiagnosticText, DeploymentIngressBinding,
    DeploymentOperationBinding, DeploymentPolicy, DeploymentRevision, ExecutableBody,
    ExecutableExport, ExecutableIr, ExecutableKind, ExecutableSignatureIr, ExprIr, FileIrRef,
    ...
    PackageBuildId, PackageCallableId, PackageCallableLinkFact, PackageCallableParameter,
    PackageCallableRef, PackageCallableSignature, PackageImplementationLinks, PackageLocalAbi,
    ...
    SlotLayout, SyntheticInstructionSiteReason, TypeRefIr, PACKAGE_ARTIFACT_SCHEMA_VERSION,
